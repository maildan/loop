            ...
            try {
                ...
                if (pid && structures[pid]) {
                    const stored = structures[pid].find({
                        "SynopsisView.useState.stored": (it)=>it.id === synopsisId
                    }["SynopsisView.useState.stored"]);
                    if (stored && stored.content) {
                        try {
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].warn('SYNOPSIS_VIEW', 'Failed to parse stored content', {
                                error: e
                            });
                        }
                    }
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('SYNOPSIS_VIEW', 'Failed to load synopsis from store', {
                    error
                });
            }
            // 빈 배열로 시작 (더미 데이터 제거)
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SynopsisView.useEffect": ()=>{
            try {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].warn('SYNOPSIS_VIEW', 'Sync error', {
                    error: e
                });
            }
        }
...
_s(SynopsisView, "3WDlJ/CzvDKDKATbwifklT+N0kA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$renderer$2f$stores$2f$useStructureStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStructureStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$renderer$2f$stores$2f$useStructureStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStructureStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$renderer$2f$stores$2f$useStructureStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStructureStore"],
