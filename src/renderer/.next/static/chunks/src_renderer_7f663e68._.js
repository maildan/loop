            ...
            items.forEach({
                "useIntegratedProjectData.useMemo[processStructureItems]": (item, index)=>{
                    ...
                    const element = {
                        ...
                        order: item.order || 0,
                        wordCount: safeContent ? safeContent.split(/\s+/).filter({
                            "useIntegratedProjectData.useMemo[processStructureItems]": (word)=>word.length > 0
                        }["useIntegratedProjectData.useMemo[processStructureItems]"]).length : 0,
