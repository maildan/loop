...
const MindmapCanvas = ({ elements, analysis, onSelectElement })=>{
    ...
    const relationships = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MindmapCanvas.useMemo[relationships]": ()=>{
            return analysis.relationships.filter({
                "MindmapCanvas.useMemo[relationships]": (rel)=>elements.find({
                        "MindmapCanvas.useMemo[relationships]": (e)=>e.id === rel.from
                    }["MindmapCanvas.useMemo[relationships]"]) && elements.find({
                        "MindmapCanvas.useMemo[relationships]": (e)=>e.id === rel.to
                    }["MindmapCanvas.useMemo[relationships]"])
            }["MindmapCanvas.useMemo[relationships]"]);
        }
    }["MindmapCanvas.useMemo[relationships]"], [
...
_s(MindmapCanvas, "AGk5Ky1j607cQ4WxhkmHGObBGII=");
_c = MindmapCanvas;
var _c;
