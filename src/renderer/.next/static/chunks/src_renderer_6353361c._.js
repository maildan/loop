        ...
        "AuthProvider.useCallback[loadAuthStatus]": async ()=>{
            ...
            try {
                ...
                if (res && res.success && res.data && res.data.isAuthenticated) {
                    ...
                    Logger.info('AUTH_CONTEXT', 'Auth status loaded', {
                        userEmail: email
                    });
                } else {
                    setAuthState(getDefaultAuth());
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                try {
                    ...
                    if (savedState) {
                        ...
                        Logger.debug('MONITORING_CONTEXT', 'State restored from localStorage (monitoring disabled)', {
                            ...parsed,
                            isMonitoring: false
                        });
                    }
        ...
        "ClientLayout.useLayoutEffect": ()=>{
            if ("TURBOPACK compile-time truthy", 1) {
                try {
                    ...
                    Logger.debug('LAYOUT', 'Sidebar state restored immediately', {
    ...
    const handleNavigate = (href)=>{
        try {
            ...
            try {
                ...
                Logger.warn('LAYOUT', 'Blocked malformed navigation URL', {
                    href
                });
                return;
            }
            ...
            if (isRelative || isSameOrigin) {
                ...
                Logger.debug('LAYOUT', 'Client-side navigation', {
                    href
                });
                router.push(href);
            } else {
                // treat as external - open in new tab/window safely
                Logger.debug('LAYOUT', 'External navigation', {
                    href
                });
    ...
    const handleToggleSidebar = ()=>{
        ...
        if ("TURBOPACK compile-time truthy", 1) {
            try {
                ...
                Logger.debug('LAYOUT', 'Sidebar state saved', {
                    collapsed: newState
                });
            } catch (error) {
...
//# sourceMappingURL=src_renderer_6353361c._.js.map