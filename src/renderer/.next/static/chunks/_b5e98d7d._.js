...
"[project]/src/shared/ai/geminiClient.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class GeminiClient {
    ...
    constructor(config){
        ...
        try {
            this.genAI = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2f$generative$2d$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GoogleGenerativeAI"](this.config.apiKey);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('GEMINI_CLIENT', `Initialized with model: ${this.config.model}`);
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('GEMINI_CLIENT', 'Failed to initialize', error);
    ...
    async generateText(request) {
        ...
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].debug('GEMINI_CLIENT', 'Generating text', {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('GEMINI_CLIENT', 'Text generation completed', {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('GEMINI_CLIENT', 'Text generation failed', {
                error: error.message,
                duration: Date.now() - startTime
            });
            // 오류 타입에 따른 분류
...
개선된 대화와 함께 변경 사유를 설명해주세요.
    ...
    async checkStatus() {
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].warn('GEMINI_CLIENT', 'Status check failed', error);
            return {
                status: 'error',
                model: this.config.model || 'gemini-1.5-flash',
                available: false
    ...
    updateConfig(newConfig) {
        ...
        if (newConfig.model) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('GEMINI_CLIENT', `Model updated to: ${newConfig.model}`);
        }
    }
}
...
function getGeminiClient() {
    if (!geminiClient) {
        ...
        const model = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.GEMINI_MODEL || 'gemini-1.5-flash';
        geminiClient = new GeminiClient({
            apiKey,
            model,
            maxTokens: parseInt(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.GEMINI_MAX_TOKENS || '4096'),
            temperature: parseFloat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.GEMINI_TEMPERATURE || '0.7')
        });
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('GEMINI_CLIENT', 'Singleton instance created');
    }
    return geminiClient;
}
...
"[project]/src/shared/narrative/ncpAnalyzer.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/shared/narrative/aiEnhancedAnalyzer.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ai$2f$geminiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/ai/geminiClient.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/logger.ts [app-client] (ecmascript)");
;
;
;
class AIEnhancedNCPAnalyzer extends __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$narrative$2f$ncpAnalyzer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NCPStoryAnalyzer"] {
    geminiClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ai$2f$geminiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGeminiClient"])();
    constructor(structure){
        super(structure);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('AI_NCP_ANALYZER', 'Initialized with AI enhancement');
    }
    // 🔥 종합 AI 분석 - 모든 분석을 통합하여 수행
    async performComprehensiveAnalysis(content, characters, plotPoints, additionalContext) {
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('AI_NCP_ANALYZER', 'Starting comprehensive analysis', {
            contentLength: content.length,
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('AI_NCP_ANALYZER', 'Comprehensive analysis completed', {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('AI_NCP_ANALYZER', 'Comprehensive analysis failed', error);
            throw error;
        }
    }
    // 🔥 시놉시스 분석
...
"[project]/src/shared/services/aiAnalysisService.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ai$2f$geminiClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/ai/geminiClient.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$narrative$2f$aiEnhancedAnalyzer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/narrative/aiEnhancedAnalyzer.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/logger.ts [app-client] (ecmascript)");
;
;
;
class AIAnalysisService {
    ...
    async analyzeTimeline(request) {
        const startTime = Date.now();
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('AI_ANALYSIS_SERVICE', 'Starting timeline analysis', {
            projectId: request.projectId
        });
        try {
            const cacheKey = this.generateCacheKey(request);
            if (this.analysisCache.has(cacheKey)) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].debug('AI_ANALYSIS_SERVICE', 'Returning cached timeline analysis');
...
반드시 유효한 JSON 형식으로만 응답해주세요.
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('AI_ANALYSIS_SERVICE', 'Timeline analysis completed', {
                duration: Date.now() - startTime,
                confidence: response.confidence
            });
            return response;
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('AI_ANALYSIS_SERVICE', 'Timeline analysis failed', error);
    ...
    async analyzeOutline(request) {
        const startTime = Date.now();
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('AI_ANALYSIS_SERVICE', 'Starting outline analysis', {
            projectId: request.projectId
        });
        try {
...

{
  ...
  "engagement": {
    ...
    "improvements": ["참여도 개선 방안들"]
            ...
            await this.saveAnalysisToDatabase(request, response);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('AI_ANALYSIS_SERVICE', 'Outline analysis completed', {
                duration: Date.now() - startTime
            });
            return response;
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('AI_ANALYSIS_SERVICE', 'Outline analysis failed', error);
    ...
    async analyzeMindmap(request) {
        const startTime = Date.now();
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('AI_ANALYSIS_SERVICE', 'Starting mindmap analysis', {
            projectId: request.projectId
        });
        try {
...

{
  ...
  "creativity": {
    ...
    "improvements": ["창의성 개선 방안들"]
            ...
            await this.saveAnalysisToDatabase(request, response);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('AI_ANALYSIS_SERVICE', 'Mindmap analysis completed', {
                duration: Date.now() - startTime
            });
            return response;
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('AI_ANALYSIS_SERVICE', 'Mindmap analysis failed', error);
    ...
    async performComprehensiveAnalysis(request) {
        const startTime = Date.now();
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('AI_ANALYSIS_SERVICE', 'Starting comprehensive analysis', {
            projectId: request.projectId
        });
        try {
            // NCP 구조 생성 (기본값)
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$narrative$2f$aiEnhancedAnalyzer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["performAIStoryAnalysis"])(ncpStructure, request.context?.content || '', request.context?.characters || [], request.context?.plotPoints || [], request.context ? JSON.stringify(request.context) : undefined);
            const response = {
                id: this.generateAnalysisId(),
                type: 'comprehensive',
                result,
            ...
            await this.saveAnalysisToDatabase(request, response);
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('AI_ANALYSIS_SERVICE', 'Comprehensive analysis completed', {
                duration: Date.now() - startTime,
                grade: result.overallAssessment.grade
            });
            return response;
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('AI_ANALYSIS_SERVICE', 'Comprehensive analysis failed', error);
    ...
    parseOutlineResponse(content) {
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].warn('AI_ANALYSIS_SERVICE', 'Failed to parse outline JSON, using fallback');
    ...
    parseMindmapResponse(content) {
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].warn('AI_ANALYSIS_SERVICE', 'Failed to parse mindmap JSON, using fallback');
    ...
    async saveAnalysisToDatabase(request, response) {
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].debug('AI_ANALYSIS_SERVICE', 'Saving analysis to database', {
                projectId: request.projectId,
                type: request.type,
        ...
        // });
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('AI_ANALYSIS_SERVICE', 'Failed to save analysis to database', error);
        // 저장 실패해도 분석 결과는 반환
        }
    }
}
...
//# sourceMappingURL=_b5e98d7d._.js.map