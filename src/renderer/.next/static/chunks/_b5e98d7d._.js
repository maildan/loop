...
function getGeminiClient() {
    if (!geminiClient) {
        // 🔥 클라이언트와 서버 환경 모두 지원
        const apiKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.GEMINI_API_KEY || ("TURBOPACK compile-time value", "AIzaSyBMVJIOQT-WcnpGY31tMPdhOBsUAFhD_7U");
        if ("TURBOPACK compile-time falsy", 0) {
            "TURBOPACK unreachable";
        }
        const model = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.GEMINI_MODEL || ("TURBOPACK compile-time value", "gemini-2.5-flash-lite") || 'gemini-1.5-flash';
