...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module '../../shared/logger'");
...
function useSettings() {
   ...
   */ const updateSetting = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (category, key, value)=>{
        ...
        try {
            ...
            Logger.debug('USE_SETTINGS', `Updating setting: ${keyPath}`, {
                value
            });
            const result = await window.electronAPI.settings.set(keyPath, value);
            if (result.success) {
                Logger.info('USE_SETTINGS', `Setting updated successfully: ${keyPath}`, {
                    value
                });
                ...
                if (category === 'app' && key === 'theme') {
                    try {
                        ...
                        Logger.debug('USE_SETTINGS', 'Theme also saved to localStorage', {
                            theme: value
                        });
                    } catch (error) {
...
const Avatar = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["forwardRef"])(({ size = 'md', src, alt, fallback, status, className, children, onClick, 'aria-label': ariaLabel, ...props }, ref)=>{
    ...
    const handleClick = ()=>{
        if (!onClick) return;
        Logger.info('AVATAR', 'Avatar clicked', {
            size,
            hasImage: !!src
        });
        onClick();
...
function Tooltip({ content, children, side = 'top', variant = 'default', delay = 200, disabled = false, showArrow = true, trigger = 'hover', open: controlledOpen, onOpenChange, className, sideOffset = 0 }) {
    ...
    const setOpen = (open)=>{
        ...
        Logger.debug('TOOLTIP', `Tooltip ${open ? 'opened' : 'closed'}`, {
            side,
            trigger
        });
    };
...
const Badge = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["forwardRef"])(({ variant = 'default', size = 'md', interactive = false, disabled = false, className, children, onClick, role, 'aria-label': ariaLabel, 'aria-pressed': ariaPressed, ...props }, ref)=>{
    ...
    const handleClick = ()=>{
        ...
        Logger.info('BADGE', `Badge clicked: ${variant}`, {
            size,
            interactive
        });
        onClick();
...
function AppSidebar({ activeRoute = '/', onNavigate, collapsed: controlledCollapsed, onToggleCollapse }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (accountProfile?.avatar) {
            ...
            Logger.debug('APPSIDEBAR', 'Using local account profile avatar (priority)', {
                avatarValue
            });
            ...
            if (v.startsWith('file://')) {
                ...
                Logger.debug('APPSIDEBAR', 'Using loop-avatar:// or data: URL', {
                    url: v.substring(0, 50) + '...'
                });
                setAvatarSrc(v);
            } else {
                Logger.debug('APPSIDEBAR', 'Using direct avatar URL', {
                    url: v
                });
                setAvatarSrc(v);
            }
        ...
        if (authLoaded && googleUserInfo && googleUserInfo.isAuthenticated) {
            ...
            Logger.debug('APPSIDEBAR', 'Using Google profile picture (fallback)', {
                picture
            });
        ...
        if (accountProfile && (accountProfile.displayName || accountProfile.username || accountProfile.email)) {
            ...
            Logger.debug('APPSIDEBAR', 'Using fallback generated avatar', {
                name,
                fallbackUrl
            });
            ...
            const unsub = window.electronAPI.settings.onDidChange?.((payload)=>{
                ...
                if (payload.keyPath === 'account.avatar' || payload.keyPath === 'account.avatarThumb') {
                    ...
                    if (val.startsWith('file://')) {
                        ...
                        Logger.debug('APPSIDEBAR', 'Loading file:// avatar from broadcast', {
                            path: p
                        });
                        ...
                        Logger.debug('APPSIDEBAR', 'Setting avatar from broadcast', {
    ...
    const handleNavigate = (item)=>{
        Logger.info('SIDEBAR', `Navigation to ${item.label}`, {
            href: item.href
        });
...
function AppHeader({ onMenuToggle, user, notificationCount = 0, onSearch, onNotificationClick, onUserClick }) {
    ...
    const handleSearch = (event)=>{
        event.preventDefault();
        if (searchQuery.trim()) {
            Logger.info('HEADER', 'Search performed', {
                query: searchQuery
            });
    ...
    const handleNotificationClick = ()=>{
        Logger.info('HEADER', 'Notifications clicked', {
            count: notificationCount
        });
        onNotificationClick?.();
    };
    const handleUserClick = ()=>{
        Logger.info('HEADER', 'User menu clicked', {
...
function ThemeProvider({ children, defaultTheme = 'system' }) {
    ...
    const setTheme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (newTheme)=>{
        try {
            Logger.info('THEME_PROVIDER', 'Theme changing', {
                from: theme,
                to: newTheme
            });
            ...
            try {
                ...
                if (result.success) {
                    Logger.info('THEME_PROVIDER', 'Theme saved to backend', {
                        theme: newTheme,
                        resolved
                    });
                } else {
                ...
                try {
                    if (window.electronAPI?.settings?.get) {
                        ...
                        if (result.success && result.data) {
                            ...
                            if ([
                                ...
                                themeSource = 'backend';
                                Logger.info('THEME_PROVIDER', 'Theme loaded from backend', {
                                    theme: savedTheme
                                });
                            }
                        }
                    ...
                    try {
                        ...
                        if (localTheme && [
                            ...
                            Logger.info('THEME_PROVIDER', 'Theme loaded from localStorage', {
                                theme: savedTheme
                            });
                        }
                    } catch (error) {
...
function ClientLayout({ children, initialAuth }) {
    ...
    const handleNavigate = (href)=>{
        try {
            ...
            Logger.warn('LAYOUT', 'Blocked unsafe navigation attempt', {
                href,
                error: e
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4e2ab078._.js.map