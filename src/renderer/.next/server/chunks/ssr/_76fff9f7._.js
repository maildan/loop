...
class AIAnalysisService {
    ...
    async performWorkflowAnalysis(timelineData, context) {
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Logger"].warn('AI_ANALYSIS_SERVICE', 'Workflow analysis failed', error);
            return {
                storyDynamics: {
                    driver: 'action',
                    outcome: 'unknown'
    ...
    async performNCPAnalysis(timelineData, context) {
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Logger"].warn('AI_ANALYSIS_SERVICE', 'NCP pre-analysis failed, using basic analysis', error);
            return {
...
- 실제 제공된 마인드맵 데이터에만 기반한 분석 제공
    ...
    parseTimelineResponse(content) {
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Logger"].debug('AI_ANALYSIS_SERVICE', 'Raw Gemini response', {
                contentLength: content.length,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Logger"].debug('AI_ANALYSIS_SERVICE', 'JSON parsing successful', {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Logger"].error('AI_ANALYSIS_SERVICE', 'JSON parse error details', {
