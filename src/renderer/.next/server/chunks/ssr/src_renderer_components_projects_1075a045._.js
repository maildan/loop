    ...
    const loadProject = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            ...
            if (result && result.success && result.data) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Logger"].error('PROJECT_DATA', 'Project not found or failed to load', {
                    projectId,
                    error: errorMsg
                });
                // 🔥 프로젝트가 삭제되었거나 존재하지 않는 경우 프로젝트 목록으로 리다이렉트
                if (errorMsg.includes('찾을 수 없습니다') || errorMsg.includes('not found')) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Logger"].info('PROJECT_DATA', 'Project does not exist, redirecting to projects page');
        ...
        try {
            ...
            try {
                ...
                if (!existsResult.success) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Logger"].error('PROJECT_DATA', 'Cannot save: project does not exist', {
                        projectId
                    });
                    throw new Error('프로젝트가 존재하지 않습니다. 프로젝트 목록으로 이동합니다.');
                }
            } catch (checkError) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Logger"].error('PROJECT_DATA', 'Project existence check failed', checkError);
...
//# sourceMappingURL=src_renderer_components_projects_1075a045._.js.map