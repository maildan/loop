...
const WRITE_CONTROLS_STYLES = {
    ...
    distractionFreeExit: 'fixed top-4 right-4 w-8 h-8 flex items-center justify-center rounded-full bg-black/50 text-white hover:bg-black/70 transition-colors duration-200 z-50',
} as const;
